        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/SystemSetup/AdditionalExpenseType" class="nav-link" id="aAdditionalExpense">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Additional Expense</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/BusinessInformation" class="nav-link" id="aBusinessInformation">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Business Information</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/Supplier" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Supplier</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/Brand" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Brand</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/Category" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/Discount" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Discount</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/Product" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/SystemSetup/User" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/Reports/InventoryHistory" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Inventory History</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/Reports/ReturnHistory" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Return History</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/Reports/OrderHistory" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Order History</p>
                </a>
              </li>
