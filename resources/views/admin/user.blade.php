                ...
                <div class="row">
                    <div class="col-lg-8 pb-0">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control" placeholder="Enter Name here" id="txtName">
                        </div> 
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 pb-0">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Username here" id="txtUsername">
                        </div> 
                    </div>
                    <div class="col-lg-6 pb-0">
                        <div class="form-group">
