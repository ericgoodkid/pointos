...
@section('additional-script')
    ...
    <script src="{{ asset('/js/admin/additional_expense_type.js') }}"></script>
@endsection
                ...
                <div class="row">
                    <div class="col-lg-6 pb-0">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Additional Expense Type here" id="txtName">
                        </div>
                    </div>
                </div>
            </form>
