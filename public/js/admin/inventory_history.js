$(document).ready(function () {
    ...
    const oManage = function() {
        ...
        const clickSaveFilter = async function () {
            const oRangePicker = await getConstant.oTxtTimespan.data('daterangepicker')
            sStartDate = oRangePicker.startDate._d.toString().substr(0, 24);
            sEndDate = oRangePicker.endDate._d.toString().substr(0, 24);
            oFilter = {
                sStartDate,
                sEndDate
            }
            ...
            // const oResult = await axios.get(`/api/admin/inventoryhistory?sStartDate=${sStartDate}&sEndDate=${sEndDate}&`).then(oResponse => oResponse.data);
        ...
        const initTable = function() {
            ...
            //     'ajax': {
            //         'url'  : '/api/admin/inventoryhistory',
            //         'type' : 'get',
            //         'data' : oFilter,
            //         cache: true
            //     },
