$(document).ready(function () {
    ...
    const oManage = function() {
        ...
        const createItem = async function() {
            const oItem = getForm();
            const oResult = await axios.post('/api/admin/category', {
                oItem
        ...
        const updateItem = async function() {
            const oItem = getForm();
            const oResult = await axios.put('/api/admin/category', {
                oItem
            }).then(oResponse => oResponse.data);
        ...
        const getItem = async function(sCode) {
            return await axios.get(`/api/admin/category/${sCode}`)
            .then(oResponse => oResponse.data);
        }
        ...
        const deleteItem = async function(oEvent) {
            ...
            const oResponse = await axios.delete('/api/admin/category', {
                data : { 
                    oItem : {
                        code : sCode
                    } 
